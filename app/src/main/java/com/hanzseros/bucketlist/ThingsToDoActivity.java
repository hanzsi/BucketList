package com.hanzseros.bucketlist;
...
public class ThingsToDoActivity extends AppCompatActivity {
    ...
    private void setupList() {
        BucketListEntry[] thingsToDo = {
                ...
                new BucketListEntry("Road trip across the USA", "Hire a car from the west coast and travel to the east coast.", R.drawable.road_trip, 4.5f ),
